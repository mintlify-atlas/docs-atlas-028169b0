---
title: "Analytics Dashboards and Workforce Reports"
sidebarTitle: "Analytics"
description: "Role-scoped dashboards and workforce reports covering KPIs, attendance trends, task stats, and performance scoring across Admin, Manager, and Employee views."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Performance Metrics" icon="chart-line">
    A dedicated scoring engine computes `Utilization`, `Consistency`, and `Output` scores from weighted combinations of the sources above. Exposed through `GET /analytics/admin/analytics` endpoints.
  </Card>
</CardGroup>
