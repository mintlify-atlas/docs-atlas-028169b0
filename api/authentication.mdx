---
title: "Authenticating with the Workforce OS API"
sidebarTitle: "Auth Endpoints"
description: "Complete reference for all auth endpoints: login, token refresh, logout, password reset, and invited-user account activation."
---
