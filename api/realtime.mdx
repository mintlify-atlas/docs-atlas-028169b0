---
title: "WebSocket, Presence, Notifications & Meetings REST API"
sidebarTitle: "Realtime"
description: "Connect over WebSocket with a single-use ticket, track live presence, manage in-app and push notifications, and schedule meetings."
---
...
<ResponseField name="online_state" type="string">Will be `"offline"` after a successful call.</ResponseField>
<ResponseField name="is_online" type="boolean">Always `false`.</ResponseField>
<ResponseField name="presence_status" type="string">User-set status label.</ResponseField>
<ResponseField name="last_seen_at" type="string | null">ISO-8601 UTC timestamp of the final heartbeat.</ResponseField>
<ResponseField name="platforms" type="array">Remaining active platforms after this device goes offline.</ResponseField>
...
<ResponseField name="users" type="object">
  ...
  <Expandable title="OnlinePresenceRead fields">
    ...
    <ResponseField name="presence_updated_at" type="string | null">ISO-8601 UTC when presence status was last changed.</ResponseField>
    <ResponseField name="last_seen_at" type="string | null">ISO-8601 UTC of last heartbeat.</ResponseField>
...
<ResponseField name="is_read" type="boolean">Always `true` after a successful call.</ResponseField>
<ResponseField name="read_at" type="string">ISO-8601 UTC timestamp set at read time.</ResponseField>
...
<ResponseField name="email_notifications" type="boolean">Whether email delivery is enabled.</ResponseField>
<ResponseField name="push_notifications" type="boolean">Whether push delivery is enabled.</ResponseField>
...
<ParamField body="email_notifications" type="boolean">Enable or disable email notification delivery.</ParamField>
<ParamField body="push_notifications" type="boolean">Enable or disable push notification delivery.</ParamField>
...
<ResponseField name="public_key" type="string | null">VAPID public key string, or `null` if Web Push is not configured on this server.</ResponseField>
<ResponseField name="configured" type="boolean">Whether VAPID credentials are configured on the server.</ResponseField>
...
<ResponseField name="message" type="string">Confirmation — `"Push subscription registered."` or `"Push subscription updated."`</ResponseField>
...
<ParamField body="p256dh" type="string" required>Client public key.</ParamField>
<ParamField body="auth" type="string" required>Auth secret.</ParamField>

<ResponseField name="message" type="string">Always `"Push subscription removed."` on success.</ResponseField>
...
<ResponseField name="configured" type="boolean">Whether VAPID is configured.</ResponseField>
<ResponseField name="message" type="string">Human-readable outcome description.</ResponseField>
<ResponseField name="subscriptions" type="integer">Number of active subscriptions found.</ResponseField>
<ResponseField name="attempted" type="integer">Number of push attempts made.</ResponseField>
<ResponseField name="sent" type="integer">Number of successful deliveries.</ResponseField>
<ResponseField name="failed" type="integer">Number of failed deliveries.</ResponseField>
...
<ParamField body="expo_push_token" type="string" required>
...
<ParamField body="device_name" type="string">Human-readable device name.</ParamField>
<ParamField body="device_id" type="string">Stable device identifier.</ParamField>
<ParamField body="app_version" type="string">App version string.</ParamField>
<ParamField body="build_version" type="string">App build number.</ParamField>
<ParamField body="environment" type="string">One of `development`, `preview`, `production`. Defaults to `development`.</ParamField>

<ResponseField name="id" type="string">UUID of the device token record.</ResponseField>
<ResponseField name="expo_push_token" type="string" />
<ResponseField name="platform" type="string" />
<ResponseField name="is_active" type="boolean">Always `true` after successful registration.</ResponseField>
...
<ParamField body="expo_push_token" type="string">
  Specific token to revoke. Omit to revoke all active tokens for the user.
</ParamField>

<ResponseField name="message" type="string">Always `"Device token unregistered."` on success.</ResponseField>
...
<ResponseField name="[]" type="array">Array of `MeetingRead` objects with `status = "scheduled"` and `start_at >= now`.</ResponseField>
...
<ResponseField name="id" type="string">UUID of the meeting.</ResponseField>
<ResponseField name="title" type="string" />
<ResponseField name="organizer_id" type="string" />
<ResponseField name="start_at" type="string">ISO-8601 UTC datetime.</ResponseField>
<ResponseField name="end_at" type="string">ISO-8601 UTC datetime.</ResponseField>
<ResponseField name="status" type="string">`scheduled` or `cancelled`.</ResponseField>
...
<ResponseField name="id" type="string" />
<ResponseField name="status" type="string">Always `"cancelled"` after a successful call.</ResponseField>
...
<ResponseField name="id" type="string">UUID of the updated meeting.</ResponseField>
<ResponseField name="status" type="string">Meeting status (unchanged by RSVP).</ResponseField>
