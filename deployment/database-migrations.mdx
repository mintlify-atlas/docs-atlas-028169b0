...
description: "How Workforce OS manages its PostgreSQL schema with Alembic, seeds permissions and the bootstrap admin, and handles development vs production database concerns."
---
